...
for (const entryPath of entryPaths) {
  ...
  if (entryPath === "/privacy") {
    for (const marker of [
      ...
      "Cloudflare, through Lovable hosting, uses the __cf_bm cookie as a strictly necessary security and bot-management cookie to help distinguish legitimate traffic and protect the hosted site from automated abuse.",
      "Observed production responses set this platform-controlled cookie for the lovable.app domain and / path with an expiration approximately 30 minutes after the response.",
      "It is generated by the hosting and security infrastructure, not TruthTrace application code.",
      "TruthTrace does not use it for advertising, marketing, personalization, or visitor analytics.",
