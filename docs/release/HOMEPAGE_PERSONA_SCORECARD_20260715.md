# TruthTrace Homepage Persona Scorecard — 2026-07-15
...
| Persona                            | Comprehension |         Trust | Differentiation |         Proof | Emotional safety |   CTA clarity |          Mean |
| ---------------------------------- | ------------: | ------------: | --------------: | ------------: | ---------------: | ------------: | ------------: |
| Overwhelmed parent                 |         7 → 9 |         4 → 8 |           8 → 8 |         5 → 8 |            4 → 9 |         5 → 9 |     5.5 → 8.5 |
| Family-law attorney                |         8 → 9 |         4 → 7 |           9 → 9 |         5 → 8 |            6 → 8 |         5 → 7 |     6.2 → 8.0 |
| Evaluator or forensic professional |         7 → 9 |         3 → 8 |           8 → 8 |         4 → 8 |            3 → 9 |         4 → 8 |     4.8 → 8.3 |
| Investor                           |         8 → 9 |         3 → 6 |           8 → 8 |         3 → 7 |            6 → 8 |         5 → 7 |     5.5 → 7.5 |
| Patent counsel                     |         7 → 8 |         3 → 7 |           7 → 8 |         3 → 7 |            6 → 8 |         4 → 7 |     5.0 → 7.5 |
| Security-conscious visitor         |         6 → 9 |         2 → 7 |           7 → 8 |         2 → 7 |            3 → 9 |         3 → 8 |     3.8 → 8.0 |
| **All-persona mean**               | **7.2 → 8.8** | **3.2 → 7.2** |   **7.8 → 8.2** | **3.7 → 7.7** |    **4.7 → 8.5** | **4.3 → 7.7** | **5.1 → 8.0** |
...
The candidate uses neutral observations and repeatedly distinguishes cited text from interpretation. The evaluator view explicitly avoids intent, credibility, and responsibility inferences and tells the reviewer to inspect source records before drawing conclusions. The proof-chain control retains visible source, citation, excerpt, event, and illustrative hash identity across roles.

The page models role-aware framing; it does not claim role-gated production access. Proof remains below 10 because the artifacts are representative, not an independently validated system or forensic method.

### D — Investor

The market problem, family-law wedge, product-mechanism concept, and responsible boundaries remain legible without modeled performance numbers or unsupported operating claims. Differentiation rests on source identity, visible provenance, cited observations, and professional review rather than generic “AI” language.

Investor trust and proof remain the lowest after-scores because no customer outcomes, live product telemetry, pilot validation, production deployment identity, or approved expansion evidence is available. The page is appropriately not a pitch deck; diligence must happen outside this public artifact.
...
- Present-tense capability and pilot claims became planned design objectives or were removed.
- Concrete modeled metrics and adverse case-like findings were removed or neutralized.
- Representative, illustrative, static, and not-live disclosures became persistent and adjacent to sample UI.
