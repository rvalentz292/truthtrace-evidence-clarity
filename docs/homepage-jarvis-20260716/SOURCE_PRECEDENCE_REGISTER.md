...
|    2 | Current test and build contracts                        | 20/20 tests; compatibility date `2026-07-15`; 32 required files; frozen dependency state | CURRENT AUTHORITATIVE                        | Safety constraints; source-pattern tests remain limited without browser evidence |
...
|    5 | Draft PR #6 and GitHub Actions CI                       | Candidate `4fc4f133…`; run `29510743848`, job `87663236467`, green                       | CURRENT AUTHORITATIVE candidate evidence     | Exact-candidate gate proof; not live-deployment proof                            |
|    6 | Draft PR #5                                             | Open draft, conflicting, no checks/reviews                                               | CURRENT BUT CONFLICTING                      | File-level historical evidence; not merge authority                              |
|    7 | Current Lovable project state                           | Project `27174261-3589-4c48-bd32-0375b044b3d9`, provider hostname                        | CURRENT BUT LIMITED                          | Provider identity only; exact-SHA synchronization remains unresolved             |
|    8 | Historical release documentation                        | `docs/release/*20260715*`                                                                | HISTORICAL                                   | Risk and policy context only; no inherited gate result                           |
|    9 | Prior homepage prompts and superseded design directions | Audit-start dirty draft and `homepage-master-20260716` records                           | SUPERSEDED / NOT SAFE TO APPLY               | Preserve for recovery; do not stage, publish, or cite as current proof           |
...
| Wall-clock-generated worker compatibility vs pinned toolchain           | Pin `2026-07-15` and validate the generated worker artifact                        |
