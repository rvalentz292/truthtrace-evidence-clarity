...
function NotFoundComponent() {
  useEffect(() => {
    const frame = requestAnimationFrame(() => {
      document.title = "Page Not Found | TruthTrace";
    });
  ...
  return (
    <main
      ...
      tabIndex={-1}
    >
      <title>Page Not Found | TruthTrace</title>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <main
      ...
      tabIndex={-1}
    >
      <title>Page Error | TruthTrace</title>
      <meta name="robots" content="noindex, nofollow, noarchive" />
      <div className="max-w-md text-center">
  ...
  return (
    <html lang="en">
      ...
      <body>
        <a
          href="#main-content"
          className="fixed left-4 top-3 z-[200] inline-flex min-h-11 -translate-y-20 items-center rounded-md bg-foreground px-4 py-2 text-sm font-semibold text-background transition-transform focus:translate-y-0"
        >
