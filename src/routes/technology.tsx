  ...
  head: () => ({
    meta: [
      { title: "Technology | TruthTrace" },
      {
        name: "description",
        content:
          "Why TruthTrace is different: evidence identity, provenance, incremental processing, citation-bound outputs, and professional review.",
      },
      { property: "og:title", content: "TruthTrace Evidence Technology" },
      {
        property: "og:description",
        content:
          "Evidence infrastructure designed for integrity, efficiency, and professional review.",
      },
    ],
  }),
...
const differentiators = [
  {
    ...
    body: "Every record remains distinguishable and reviewable as evidence moves from fragmented source material into a structured record.",
  },
  {
    icon: GitBranch,
    title: "Provenance",
    body: "Source relationships remain visible so professionals can understand where information came from and evaluate it in context.",
  },
  {
    icon: Layers3,
    title: "Incremental Processing",
    body: "Validated work can be reused as new evidence arrives, reducing unnecessary reprocessing and preserving continuity across review cycles.",
  },
  {
    icon: Quote,
    title: "Citation-Bound Outputs",
    body: "Findings remain connected to supporting records, helping reviewers move from an observation back to its source.",
  },
  {
    icon: UserCheck,
    title: "Professional Review",
    body: "Outputs are designed to support qualified judgment—not replace attorneys, evaluators, courts, or other professionals.",
  },
];
        ...
        <Section className="!pb-16 !pt-20 sm:!pb-24 sm:!pt-28">
          <div className="max-w-5xl">
            ...
            <p className="mt-6 max-w-3xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              Evidence infrastructure designed to preserve integrity, reduce repeated work, and make
              complex records easier for qualified professionals to review.
            </p>
          </div>
        </Section>
        ...
        <section className="relative border-y border-border bg-surface/20">
          <Section>
            <SectionHeader
              ...
              title={
                <>
                  Built around the integrity of the{" "}
          ...
          <div className="grid gap-8 border-y border-border py-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight">
                Built for defensible review.
              </h2>
            </div>
            <div className="flex gap-4">
              <CheckCircle2 className="mt-1 size-5 shrink-0 text-success" />
              <p className="max-w-3xl text-base leading-relaxed text-muted-foreground">
                TruthTrace uses an architecture focused on evidence identity, provenance, consistent
                processing, and source-linked outputs.
              </p>
            </div>
          </div>
        </Section>
